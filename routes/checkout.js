...
//iamport 연동 
//iamport 개발자 페이지 - 시스템 설정 에서 참고
const { Iamporter, IamporterError } = require('iamporter');
const iamporter = new Iamporter({
    apiKey: '1083988754195944',
    secret: '2EnQPfgZkanj3e2zFaxga1LUdiB39Iacny2cNjb7tzrwNt5tEDKPEvJSOkVY36bqEdCsxOA0n1xbvDFa'
});
...
router.get('/shipping/:invc_no', (req,res)=>{
    ...
    request(url, (error, response, body) => {  
        ...
        //console.log( removeEmpty(tdElements[0].children[0].data)) ;//로 찍어본다.

        //console.log((removeEmpty(tdElements[1].children[0].data))) ;//로 찍어본다.
 
        
        //console.log((removeEmpty(tdElements[6].children[2].data))) ;//로 찍어본다.
 
        //console.log((removeEmpty(tdElements[3].children[1].children[0].data))) ;//로 찍어본다.
